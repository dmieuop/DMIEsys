...
return new class extends Migration
{
    public function up()
    {
        Schema::create('tutorial_marks', function (Blueprint $table) {
            $table->string('student_id', 6);
            $table->string('tutorial_code', 15);
            ...
            $table->timestamps();
            $table->primary(['student_id', 'tutorial_code', 'course_id']);
            ...
            $table->foreign('tutorial_code')->references('tutorial_code')->on('tutorials')->onUpdate('cascade')->onDelete('cascade');
        });
    }
};
