...
return new class extends Migration
{
    public function up()
    {
        Schema::create('quiz_marks', function (Blueprint $table) {
            ...
            $table->timestamps();
            $table->primary(['student_id', 'quiz_code', 'course_id']);
            ...
            $table->foreign('quiz_code')->references('quiz_code')->on('quizzes')->onUpdate('cascade')->onDelete('cascade');
        });
    }
};
