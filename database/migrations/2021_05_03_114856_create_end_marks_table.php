...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('end_marks', function (Blueprint $table) {
            $table->string('student_id', 6);
            $table->string('end_question_code', 15);
            ...
            $table->timestamps();
            $table->primary(['student_id', 'end_question_code', 'course_id']);
            ...
            $table->foreign('end_question_code')->references('end_question_code')->on('end_exam_questions')->onUpdate('cascade')->onDelete('cascade');
        });
    }
};
