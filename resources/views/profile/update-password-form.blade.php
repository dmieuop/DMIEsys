<x-form-section submit="updatePassword">
    ...
    <x-slot name="form">
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <div id="passwordHelp" class="form-input-help">
                New password must be 12-30 characters long, contain
                letters, numbers and symbol, and must not contain spaces or emoji.</div>
