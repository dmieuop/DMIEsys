<x-action-section>
    ...
    <x-slot name="content">
        ...
        <div class="mt-4 p-2 bg-white" style="width: 208px">
        ...
        <div
            class="grid gap-1 max-w-xl mt-4 px-4 py-4 font-mono text-sm bg-gray-100 dark:bg-gray-600 dark:text-white rounded-lg">
