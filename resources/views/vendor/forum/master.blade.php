...
<head>
    ...
    {{-- <script src="https://cdn.ckeditor.com/ckeditor5/32.0.0/inline/ckeditor.js"></script> --}}
...
<body>
    <nav class="v-navbar navbar navbar-expand-md navbar-dark shadow-sm" style="background: #1E429F">
        <div class="container-fluid">
            <a class="navbar-brand fw-bold text-warning fs-3"
                href="{{ url(config('forum.web.router.prefix')) }}">DMIEsys
                forum</a>
                ...
                <ul class="navbar-nav">
                    @auth
                        <li class="nav-item dropdown">
                            <div class="btn-group">
                                <a type="button" class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink"
                                    data-bs-toggle="dropdown" aria-expanded="false">
                                    {{ auth()->user()->username }}
                                </a>
                                <ul class="dropdown-menu dropdown-menu-end">
                                    <li><a href="{{ route('user-profile.edit', auth()->user()->username) }}"
                                            class="fw-bolder text-secondary dropdown-item" type="button">Profile</a></li>
                                    @canany([
                                        'add new hod',
                                        'select new hod',
                                        'add user',
                                        ...
                                        <li><a href="{{ route('settings.index') }}"
                                                class="fw-bolder text-secondary dropdown-item" type="button">Settings</a></li>
                                    @endcan
                                    @can('can chat')
                                        <li><a ref="{{ route('messages.index') }}"
                                                class="fw-bolder text-secondary dropdown-item" type="button">Messages</a></li>
                                    @endcan
                                    <form id="logout-form" action="{{ route('logout') }}" method="POST">
                                        @csrf
                                        <a href="#" class="fw-bolder text-danger dropdown-item" role="menuitem"
