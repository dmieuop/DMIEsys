    ...
    <div class="flex items-center justify-center py-12 main">
        <div class="bg-transparant rounded-md flex items-center justify-center mx-4 md:w-2/3">
            <div class="flex flex-col items-center py-16">
                <img style="width: 30rem" class="mb-2" src="{{ asset('src/img/error/500.svg') }}" alt="404 error">
                ...
                <p class="pt-4 text-center font-semibold text-gray-800 dark:text-gray-400">
                    An error has occurred on the server. This error has nothing to do with you. We'll be up and running
                    shortly. This should take just a while longer.
                </p>
            </div>
        </div>
    </div>
